...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    rot(text, step) {
      var t1, t2, t3, result, _i, char,
        _s26_ = "abcdefghijklmnopqrstuvwxyz",
        ALPHA = "abcdefghijklmnopqrstuvwxyz".toUpperCase();
      for (t1 = text.split(""), t2 = t1.length, t3 = ALPHA.length, result = "", _i = 0; _i < t2; ++_i) {
        char = t1[_i];
        if (B.JSString_methods.contains$1(_s26_, char))
          result += _s26_[B.JSInt_methods.$mod(B.JSString_methods.indexOf$1(_s26_, char) + step, 26)];
        else
          result = B.JSString_methods.contains$1(ALPHA, char) ? result + ALPHA[B.JSInt_methods.$mod(B.JSString_methods.indexOf$1(ALPHA, char) + step, t3)] : B.JSString_methods.$add(result, char);
      }
      return result;
    },
    main() {
      ...
      t1 = window.document.querySelector("#input");
      t1.toString;
      type$.TextAreaElement._as(t1);
      t2 = window.document.querySelector("#output");
      t2.toString;
      t3 = window.document.querySelector("#offset");
      t3.toString;
      type$.NumberInputElement._as(t3);
      t4 = type$._ElementEventStreamImpl_Event;
      t5 = t4._eval$1("~(1)?");
      t4 = t4._precomputed1;
      A._EventStreamSubscription$(t1, "input", t5._as(new A.main_closure(t2, t1, t3)), false, t4);
      A._EventStreamSubscription$(t3, "change", t5._as(new A.main_closure0(t2, t1, t3)), false, t4);
    },
  ...
  A.InputElement.prototype = {$isNumberInputElement: 1};
  A.Node.prototype = {
    toString$0(receiver) {
  ...
  A.main_closure.prototype = {
    call$1($event) {
      var t2,
        t1 = this.input.value;
      t1.toString;
      t2 = this.offset.valueAsNumber;
      t2.toString;
      J.set$text$x(this.output, A.rot(t1, B.JSNumber_methods.toInt$0(t2)));
    },
    $signature: 1
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.Event]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.FormElement, A.InputElement, A.SelectElement, A.TextAreaElement]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      Null: findType("Null"),
      NumberInputElement: findType("NumberInputElement"),
